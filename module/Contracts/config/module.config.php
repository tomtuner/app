...
return array(
    'controllers' => array(
        ...
        'invokables' => array(
            ...
            'Contracts\Controller\ContractsRequestController' => 'Contracts\Controller\ContractsRequestController',
            ...
            'Contracts-index' => array(
                ...
                'options' => array(
                    ...
                    'defaults' => array(
						...
						'controller' => 'Contracts\Controller\ContractsRequestController',
                        'action' => 'index',
                    ),
                ),
            ),
...
//             ),
    ...
    'view_manager' => array(
        ...
        'template_map' => array(
			...
			'contracts/contracts-request/index' => __DIR__ . '/../view/contracts/contracts-request/index.phtml',
        ),
