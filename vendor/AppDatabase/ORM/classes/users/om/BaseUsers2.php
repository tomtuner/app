...
/**
 * Base class that represents a row from the 'users2' table.
 *
 * 
 *
 * @package    propel.generator.users.om
 */
abstract class BaseUsers2 extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'UsersORM\\Users2Peer';
	...
	/**
	 * Initializes internal state of BaseUsers2 object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Users2 The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = Users2Peer::ID;
		}
	...
	public function setUid($v)
	{
		...
		if ($this->uid !== $v) {
			$this->uid = $v;
			$this->modifiedColumns[] = Users2Peer::UID;
		}
	...
	public function setUsername($v)
	{
		...
		if ($this->username !== $v) {
			$this->username = $v;
			$this->modifiedColumns[] = Users2Peer::USERNAME;
		}
	...
	public function setFirstName($v)
	{
		...
		if ($this->first_name !== $v) {
			$this->first_name = $v;
			$this->modifiedColumns[] = Users2Peer::FIRST_NAME;
		}
	...
	public function setLastName($v)
	{
		...
		if ($this->last_name !== $v) {
			$this->last_name = $v;
			$this->modifiedColumns[] = Users2Peer::LAST_NAME;
		}
	...
	public function setHearingImpaired($v)
	{
		...
		if ($this->hearing_impaired !== $v) {
			...
			$this->modifiedColumns[] = Users2Peer::HEARING_IMPAIRED;
		}
	...
	public function setPrefCommMethod($v)
	{
		...
		if ($this->pref_comm_method !== $v) {
			...
			$this->modifiedColumns[] = Users2Peer::PREF_COMM_METHOD;
		}
	...
	public function setEmail($v)
	{
		...
		if ($this->email !== $v) {
			$this->email = $v;
			$this->modifiedColumns[] = Users2Peer::EMAIL;
		}
	...
	public function setPhone($v)
	{
		...
		if ($this->phone !== $v) {
			$this->phone = $v;
			$this->modifiedColumns[] = Users2Peer::PHONE;
		}
	...
	public function setAddress($v)
	{
		...
		if ($this->address !== $v) {
			$this->address = $v;
			$this->modifiedColumns[] = Users2Peer::ADDRESS;
		}
	...
	public function setScreenName($v)
	{
		...
		if ($this->screen_name !== $v) {
			$this->screen_name = $v;
			$this->modifiedColumns[] = Users2Peer::SCREEN_NAME;
		}
	...
	public function setMiddleInitial($v)
	{
		...
		if ($this->middle_initial !== $v) {
			...
			$this->modifiedColumns[] = Users2Peer::MIDDLE_INITIAL;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 12; // 12 = Users2Peer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Users2 object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Users2Peer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Users2Query::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Users2Peer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Users2Peer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(Users2Peer::UID)) {
			$modifiedColumns[':p' . $index++]  = '`UID`';
		}
		if ($this->isColumnModified(Users2Peer::USERNAME)) {
			$modifiedColumns[':p' . $index++]  = '`USERNAME`';
		}
		if ($this->isColumnModified(Users2Peer::FIRST_NAME)) {
			$modifiedColumns[':p' . $index++]  = '`FIRST_NAME`';
		}
		if ($this->isColumnModified(Users2Peer::LAST_NAME)) {
			$modifiedColumns[':p' . $index++]  = '`LAST_NAME`';
		}
		if ($this->isColumnModified(Users2Peer::HEARING_IMPAIRED)) {
			$modifiedColumns[':p' . $index++]  = '`HEARING_IMPAIRED`';
		}
		if ($this->isColumnModified(Users2Peer::PREF_COMM_METHOD)) {
			$modifiedColumns[':p' . $index++]  = '`PREF_COMM_METHOD`';
		}
		if ($this->isColumnModified(Users2Peer::EMAIL)) {
			$modifiedColumns[':p' . $index++]  = '`EMAIL`';
		}
		if ($this->isColumnModified(Users2Peer::PHONE)) {
			$modifiedColumns[':p' . $index++]  = '`PHONE`';
		}
		if ($this->isColumnModified(Users2Peer::ADDRESS)) {
			$modifiedColumns[':p' . $index++]  = '`ADDRESS`';
		}
		if ($this->isColumnModified(Users2Peer::SCREEN_NAME)) {
			$modifiedColumns[':p' . $index++]  = '`SCREEN_NAME`';
		}
		if ($this->isColumnModified(Users2Peer::MIDDLE_INITIAL)) {
			$modifiedColumns[':p' . $index++]  = '`MIDDLE_INITIAL`';
		}

		$sql = sprintf(
			'INSERT INTO `users2` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Users2Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Users2Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Users2'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Users2'][$this->getPrimaryKey()] = true;
		$keys = Users2Peer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getUid(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Users2Peer::ID)) $criteria->add(Users2Peer::ID, $this->id);
		if ($this->isColumnModified(Users2Peer::UID)) $criteria->add(Users2Peer::UID, $this->uid);
		if ($this->isColumnModified(Users2Peer::USERNAME)) $criteria->add(Users2Peer::USERNAME, $this->username);
		if ($this->isColumnModified(Users2Peer::FIRST_NAME)) $criteria->add(Users2Peer::FIRST_NAME, $this->first_name);
		if ($this->isColumnModified(Users2Peer::LAST_NAME)) $criteria->add(Users2Peer::LAST_NAME, $this->last_name);
		if ($this->isColumnModified(Users2Peer::HEARING_IMPAIRED)) $criteria->add(Users2Peer::HEARING_IMPAIRED, $this->hearing_impaired);
		if ($this->isColumnModified(Users2Peer::PREF_COMM_METHOD)) $criteria->add(Users2Peer::PREF_COMM_METHOD, $this->pref_comm_method);
		if ($this->isColumnModified(Users2Peer::EMAIL)) $criteria->add(Users2Peer::EMAIL, $this->email);
		if ($this->isColumnModified(Users2Peer::PHONE)) $criteria->add(Users2Peer::PHONE, $this->phone);
		if ($this->isColumnModified(Users2Peer::ADDRESS)) $criteria->add(Users2Peer::ADDRESS, $this->address);
		if ($this->isColumnModified(Users2Peer::SCREEN_NAME)) $criteria->add(Users2Peer::SCREEN_NAME, $this->screen_name);
		if ($this->isColumnModified(Users2Peer::MIDDLE_INITIAL)) $criteria->add(Users2Peer::MIDDLE_INITIAL, $this->middle_initial);
	...
	{
		$criteria = new Criteria(Users2Peer::DATABASE_NAME);
		$criteria->add(Users2Peer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Users2 (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Users2 Clone of current object.
	 * @throws     PropelException
	 */
	...
	{
		return (string) $this->exportTo(Users2Peer::DEFAULT_STRING_FORMAT);
	}
