...
abstract class BaseUsersPeer {
	...
	const OM_CLASS = 'UsersORM\\Users';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'users.Users';
	...
	const HEARING_IMPAIRED = 'users.HEARING_IMPAIRED';

	/** the column name for the PREF_COMM_METHOD field */
	const PREF_COMM_METHOD = 'users.PREF_COMM_METHOD';
	...
	const SCREEN_NAME = 'users.SCREEN_NAME';

	/** the column name for the MIDDLE_INITIAL field */
	const MIDDLE_INITIAL = 'users.MIDDLE_INITIAL';
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(UsersPeer::HEARING_IMPAIRED);
			$criteria->addSelectColumn(UsersPeer::PREF_COMM_METHOD);
			$criteria->addSelectColumn(UsersPeer::EMAIL);
			$criteria->addSelectColumn(UsersPeer::PHONE);
			$criteria->addSelectColumn(UsersPeer::ADDRESS);
			$criteria->addSelectColumn(UsersPeer::SCREEN_NAME);
			$criteria->addSelectColumn(UsersPeer::MIDDLE_INITIAL);
		} else {
