...
use \Propel;
use \PropelPDO;
use OrganizationsORM\Categories;
use OrganizationsORM\CategoriesPeer;
use OrganizationsORM\CategoriesQuery;
 ...
 * @method     CategoriesQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method     CategoriesQuery groupById() Group by the id column
 * @method     CategoriesQuery groupByName() Group by the name column
 *
 ...
 * @method     Categories findOneByName(string $name) Return the first Categories filtered by the name column
 *
 * @method     array findById(int $id) Return Categories objects filtered by the id column
 * @method     array findByName(string $name) Return Categories objects filtered by the name column
 *
...
abstract class BaseCategoriesQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'organizations', $modelName = 'OrganizationsORM\\Categories', $modelAlias = null)
	{
	...
	public function filterByName($name = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(CategoriesPeer::NAME, $name, $comparison);
	}
