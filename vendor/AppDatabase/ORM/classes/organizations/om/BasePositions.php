...
abstract class BasePositions extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
	const PEER = 'OrganizationsORM\\PositionsPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->position = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = PositionsPeer::NUM_HYDRATE_COLUMNS.
