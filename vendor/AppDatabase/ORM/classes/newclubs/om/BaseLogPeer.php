...
use NewClubsORM\map\LogTableMap;
...
abstract class BaseLogPeer {
	...
	const OM_CLASS = 'NewClubsORM\\Log';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'newclubs.Log';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Userid', 'Mode', 'Page', 'Data', 'Date', 'Time', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userid', 'mode', 'page', 'data', 'date', 'time', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USERID, self::MODE, self::PAGE, self::DATA, self::DATE, self::TIME, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERID', 'MODE', 'PAGE', 'DATA', 'DATE', 'TIME', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'userid', 'mode', 'page', 'data', 'date', 'time', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Userid' => 1, 'Mode' => 2, 'Page' => 3, 'Data' => 4, 'Date' => 5, 'Time' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userid' => 1, 'mode' => 2, 'page' => 3, 'data' => 4, 'date' => 5, 'time' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USERID => 1, self::MODE => 2, self::PAGE => 3, self::DATA => 4, self::DATE => 5, self::TIME => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERID' => 1, 'MODE' => 2, 'PAGE' => 3, 'DATA' => 4, 'DATE' => 5, 'TIME' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'userid' => 1, 'mode' => 2, 'page' => 3, 'data' => 4, 'date' => 5, 'time' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(LogPeer::USERID);
			$criteria->addSelectColumn(LogPeer::MODE);
			$criteria->addSelectColumn(LogPeer::PAGE);
			$criteria->addSelectColumn(LogPeer::DATA);
			$criteria->addSelectColumn(LogPeer::DATE);
			$criteria->addSelectColumn(LogPeer::TIME);
		} else {
