...
/**
 * Base class that represents a row from the 'financedates' table.
 *
 * 
 *
 * @package    propel.generator.newclubs.om
 */
abstract class BaseFinancedates extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'NewClubsORM\\FinancedatesPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        FinancedatesPeer
	 */
	...
	/**
	 * Initializes internal state of BaseFinancedates object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Financedates The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = FinancedatesPeer::ID;
		}
	...
	public function setDate($v)
	{
		...
		if ($this->date !== null || $dt !== null) {
			...
			if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
				...
				$this->modifiedColumns[] = FinancedatesPeer::DATE;
			}
	...
	public function setStartTime($v)
	{
		...
		if ($this->start_time !== null || $dt !== null) {
			...
			if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
				...
				$this->modifiedColumns[] = FinancedatesPeer::START_TIME;
			}
		} // if either are not null
	...
	public function setEndTime($v)
	{
		...
		if ($this->end_time !== null || $dt !== null) {
			...
			if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
				...
				$this->modifiedColumns[] = FinancedatesPeer::END_TIME;
			}
		} // if either are not null
	...
	public function setLocation($v)
	{
		...
		if ($this->location !== $v) {
			$this->location = $v;
			$this->modifiedColumns[] = FinancedatesPeer::LOCATION;
		}
	...
	public function setYear($v)
	{
		...
		if ($this->year !== $v) {
			$this->year = $v;
			$this->modifiedColumns[] = FinancedatesPeer::YEAR;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = FinancedatesPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Financedates object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = FinancedatesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = FinancedatesQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				FinancedatesPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(FinancedatesPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(FinancedatesPeer::DATE)) {
			$modifiedColumns[':p' . $index++]  = '`DATE`';
		}
		if ($this->isColumnModified(FinancedatesPeer::START_TIME)) {
			$modifiedColumns[':p' . $index++]  = '`START_TIME`';
		}
		if ($this->isColumnModified(FinancedatesPeer::END_TIME)) {
			$modifiedColumns[':p' . $index++]  = '`END_TIME`';
		}
		if ($this->isColumnModified(FinancedatesPeer::LOCATION)) {
			$modifiedColumns[':p' . $index++]  = '`LOCATION`';
		}
		if ($this->isColumnModified(FinancedatesPeer::YEAR)) {
			$modifiedColumns[':p' . $index++]  = '`YEAR`';
		}

		$sql = sprintf(
			'INSERT INTO `financedates` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = FinancedatesPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = FinancedatesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Financedates'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Financedates'][$this->getPrimaryKey()] = true;
		$keys = FinancedatesPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getDate(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FinancedatesPeer::ID)) $criteria->add(FinancedatesPeer::ID, $this->id);
		if ($this->isColumnModified(FinancedatesPeer::DATE)) $criteria->add(FinancedatesPeer::DATE, $this->date);
		if ($this->isColumnModified(FinancedatesPeer::START_TIME)) $criteria->add(FinancedatesPeer::START_TIME, $this->start_time);
		if ($this->isColumnModified(FinancedatesPeer::END_TIME)) $criteria->add(FinancedatesPeer::END_TIME, $this->end_time);
		if ($this->isColumnModified(FinancedatesPeer::LOCATION)) $criteria->add(FinancedatesPeer::LOCATION, $this->location);
		if ($this->isColumnModified(FinancedatesPeer::YEAR)) $criteria->add(FinancedatesPeer::YEAR, $this->year);
	...
	{
		$criteria = new Criteria(FinancedatesPeer::DATABASE_NAME);
		$criteria->add(FinancedatesPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Financedates (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Financedates Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     FinancedatesPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new FinancedatesPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(FinancedatesPeer::DEFAULT_STRING_FORMAT);
	}
