...
use NewClubsORM\map\CategoriesTableMap;
...
abstract class BaseCategoriesPeer {
	...
	const OM_CLASS = 'NewClubsORM\\Categories';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'newclubs.Categories';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Category', 'Description', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'category', 'description', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CATEGORY, self::DESCRIPTION, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CATEGORY', 'DESCRIPTION', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'category', 'description', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Category' => 1, 'Description' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'category' => 1, 'description' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CATEGORY => 1, self::DESCRIPTION => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CATEGORY' => 1, 'DESCRIPTION' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'category' => 1, 'description' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(CategoriesPeer::CATEGORY);
			$criteria->addSelectColumn(CategoriesPeer::DESCRIPTION);
		} else {
	...
	{
		return $withPrefix ? CategoriesPeer::CLASS_DEFAULT : CategoriesPeer::OM_CLASS;
	}
