...
/**
 * Base class that represents a row from the 'evrdates' table.
 *
 * 
 *
 * @package    propel.generator.newclubs.om
 */
abstract class BaseEvrdates extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'NewClubsORM\\EvrdatesPeer';
	...
	/**
	 * Initializes internal state of BaseEvrdates object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Evrdates The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = EvrdatesPeer::ID;
		}
	...
	public function setDate($v)
	{
		...
		if ($this->date !== null || $dt !== null) {
			...
			if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
				...
				$this->modifiedColumns[] = EvrdatesPeer::DATE;
			}
	...
	public function setStartTime($v)
	{
		...
		if ($this->start_time !== null || $dt !== null) {
			...
			if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
				...
				$this->modifiedColumns[] = EvrdatesPeer::START_TIME;
			}
		} // if either are not null
	...
	public function setEndTime($v)
	{
		...
		if ($this->end_time !== null || $dt !== null) {
			...
			if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
				...
				$this->modifiedColumns[] = EvrdatesPeer::END_TIME;
			}
		} // if either are not null
	...
	public function setLocation($v)
	{
		...
		if ($this->location !== $v) {
			$this->location = $v;
			$this->modifiedColumns[] = EvrdatesPeer::LOCATION;
		}
	...
	public function setYear($v)
	{
		...
		if ($this->year !== $v) {
			$this->year = $v;
			$this->modifiedColumns[] = EvrdatesPeer::YEAR;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = EvrdatesPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Evrdates object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = EvrdatesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = EvrdatesQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				EvrdatesPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(EvrdatesPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(EvrdatesPeer::DATE)) {
			$modifiedColumns[':p' . $index++]  = '`DATE`';
		}
		if ($this->isColumnModified(EvrdatesPeer::START_TIME)) {
			$modifiedColumns[':p' . $index++]  = '`START_TIME`';
		}
		if ($this->isColumnModified(EvrdatesPeer::END_TIME)) {
			$modifiedColumns[':p' . $index++]  = '`END_TIME`';
		}
		if ($this->isColumnModified(EvrdatesPeer::LOCATION)) {
			$modifiedColumns[':p' . $index++]  = '`LOCATION`';
		}
		if ($this->isColumnModified(EvrdatesPeer::YEAR)) {
			$modifiedColumns[':p' . $index++]  = '`YEAR`';
		}

		$sql = sprintf(
			'INSERT INTO `evrdates` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = EvrdatesPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = EvrdatesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Evrdates'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Evrdates'][$this->getPrimaryKey()] = true;
		$keys = EvrdatesPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getDate(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EvrdatesPeer::ID)) $criteria->add(EvrdatesPeer::ID, $this->id);
		if ($this->isColumnModified(EvrdatesPeer::DATE)) $criteria->add(EvrdatesPeer::DATE, $this->date);
		if ($this->isColumnModified(EvrdatesPeer::START_TIME)) $criteria->add(EvrdatesPeer::START_TIME, $this->start_time);
		if ($this->isColumnModified(EvrdatesPeer::END_TIME)) $criteria->add(EvrdatesPeer::END_TIME, $this->end_time);
		if ($this->isColumnModified(EvrdatesPeer::LOCATION)) $criteria->add(EvrdatesPeer::LOCATION, $this->location);
		if ($this->isColumnModified(EvrdatesPeer::YEAR)) $criteria->add(EvrdatesPeer::YEAR, $this->year);
	...
	{
		$criteria = new Criteria(EvrdatesPeer::DATABASE_NAME);
		$criteria->add(EvrdatesPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Evrdates (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Evrdates Clone of current object.
	 * @throws     PropelException
	 */
	...
	{
		return (string) $this->exportTo(EvrdatesPeer::DEFAULT_STRING_FORMAT);
	}
