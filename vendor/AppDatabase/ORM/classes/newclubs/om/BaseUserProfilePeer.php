...
use NewClubsORM\map\UserProfileTableMap;
...
abstract class BaseUserProfilePeer {
	...
	const OM_CLASS = 'NewClubsORM\\UserProfile';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'newclubs.UserProfile';
	...
	const TYPE = 'user_profile.TYPE';

	/** the column name for the SEND_EMAIL field */
	const SEND_EMAIL = 'user_profile.SEND_EMAIL';

	/** the column name for the PREFFERED_EMAIL field */
	const PREFFERED_EMAIL = 'user_profile.PREFFERED_EMAIL';

	/** the column name for the HOME_PHONE field */
	const HOME_PHONE = 'user_profile.HOME_PHONE';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserId', 'Type', 'SendEmail', 'PrefferedEmail', 'HomePhone', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'type', 'sendEmail', 'prefferedEmail', 'homePhone', ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID, self::TYPE, self::SEND_EMAIL, self::PREFFERED_EMAIL, self::HOME_PHONE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('USER_ID', 'TYPE', 'SEND_EMAIL', 'PREFFERED_EMAIL', 'HOME_PHONE', ),
		BasePeer::TYPE_FIELDNAME => array ('user_id', 'type', 'send_email', 'preffered_email', 'home_phone', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'Type' => 1, 'SendEmail' => 2, 'PrefferedEmail' => 3, 'HomePhone' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'type' => 1, 'sendEmail' => 2, 'prefferedEmail' => 3, 'homePhone' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID => 0, self::TYPE => 1, self::SEND_EMAIL => 2, self::PREFFERED_EMAIL => 3, self::HOME_PHONE => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('USER_ID' => 0, 'TYPE' => 1, 'SEND_EMAIL' => 2, 'PREFFERED_EMAIL' => 3, 'HOME_PHONE' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'type' => 1, 'send_email' => 2, 'preffered_email' => 3, 'home_phone' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(UserProfilePeer::TYPE);
			$criteria->addSelectColumn(UserProfilePeer::SEND_EMAIL);
			$criteria->addSelectColumn(UserProfilePeer::PREFFERED_EMAIL);
			$criteria->addSelectColumn(UserProfilePeer::HOME_PHONE);
		} else {
			$criteria->addSelectColumn($alias . '.USER_ID');
			$criteria->addSelectColumn($alias . '.TYPE');
			$criteria->addSelectColumn($alias . '.SEND_EMAIL');
			$criteria->addSelectColumn($alias . '.PREFFERED_EMAIL');
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(UserProfilePeer::USER_ID);
			if ($value) {
				$selectCriteria->add(UserProfilePeer::USER_ID, $value, $comparison);
			} else {
