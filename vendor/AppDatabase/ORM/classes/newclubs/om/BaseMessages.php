...
abstract class BaseMessages extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
	const PEER = 'NewClubsORM\\MessagesPeer';
	...
	public function setNotes($v)
	{
		...
		if ($this->notes !== $v) {
			$this->notes = $v;
			$this->modifiedColumns[] = MessagesPeer::NOTES;
		}
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(MessagesPeer::SUBJECT)) {
			$modifiedColumns[':p' . $index++]  = '`SUBJECT`';
		}
		if ($this->isColumnModified(MessagesPeer::BODY)) {
			$modifiedColumns[':p' . $index++]  = '`BODY`';
		}
		if ($this->isColumnModified(MessagesPeer::NOTES)) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MessagesPeer::NOTES)) $criteria->add(MessagesPeer::NOTES, $this->notes);
