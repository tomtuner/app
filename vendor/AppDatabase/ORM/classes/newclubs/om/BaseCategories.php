...
abstract class BaseCategories extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
	const PEER = 'NewClubsORM\\CategoriesPeer';
	...
	public function setCategory($v)
	{
		...
		if ($this->category !== $v) {
			$this->category = $v;
			$this->modifiedColumns[] = CategoriesPeer::CATEGORY;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = CategoriesPeer::DESCRIPTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = CategoriesPeer::NUM_HYDRATE_COLUMNS.
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(CategoriesPeer::CATEGORY)) {
			$modifiedColumns[':p' . $index++]  = '`CATEGORY`';
		}
		if ($this->isColumnModified(CategoriesPeer::DESCRIPTION)) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CategoriesPeer::CATEGORY)) $criteria->add(CategoriesPeer::CATEGORY, $this->category);
		if ($this->isColumnModified(CategoriesPeer::DESCRIPTION)) $criteria->add(CategoriesPeer::DESCRIPTION, $this->description);
