...
class NotificationsTableMap extends TableMap
{
	 ...
	 */
	const CLASS_NAME = 'newclubs.map.NotificationsTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('NewClubsORM\\Notifications');
		$this->setPackage('newclubs');
		$this->setUseIdGenerator(false);
		// columns
		$this->addPrimaryKey('ORG_ID', 'OrgId', 'SMALLINT', true, null, null);
		$this->addPrimaryKey('MEMBER_ID', 'MemberId', 'SMALLINT', true, null, null);
		// validators
	} // initialize()
