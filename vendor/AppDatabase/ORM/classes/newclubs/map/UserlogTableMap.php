...
class UserlogTableMap extends TableMap
{
	 ...
	 */
	const CLASS_NAME = 'newclubs.map.UserlogTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('NewClubsORM\\Userlog');
		$this->setPackage('newclubs');
		$this->setUseIdGenerator(true);
		// columns
		$this->addPrimaryKey('ID', 'Id', 'SMALLINT', true, 11, null);
		$this->addColumn('USERNAME', 'Username', 'VARCHAR', true, 8, '');
		$this->addColumn('TIMESTAMP', 'Timestamp', 'VARCHAR', true, 255, '');
		// validators
	} // initialize()
