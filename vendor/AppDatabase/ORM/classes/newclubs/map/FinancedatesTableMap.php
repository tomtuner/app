...
/**
 * This class defines the structure of the 'financedates' table.
 *
 *
 *
 ...
 */
class FinancedatesTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'newclubs.map.FinancedatesTableMap';
	...
	{
		// attributes
		$this->setName('financedates');
		$this->setPhpName('Financedates');
		$this->setClassname('NewClubsORM\\Financedates');
