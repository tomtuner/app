...
/**
 * This class defines the structure of the 'yearly_data_archive' table.
 *
 *
 *
 ...
 */
class YearlyDataArchiveTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'newclubs.map.YearlyDataArchiveTableMap';
	...
	{
		// attributes
		$this->setName('yearly_data_archive');
		$this->setPhpName('YearlyDataArchive');
		$this->setClassname('NewClubsORM\\YearlyDataArchive');
