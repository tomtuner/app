...
/**
 * Base class that represents a row from the 'roommate_type' table.
 *
 * 
 *
 * @package    propel.generator.commuterweek.om
 */
abstract class BaseRoommateType extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'CommuterWeekORM\\RoommateTypePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        RoommateTypePeer
	 */
	...
	/**
	 * The value for the roommate_type_name field.
	 * @var        string
	 */
	protected $roommate_type_name;
	...
	/**
	 * Get the [roommate_type_name] column value.
	 * 
	 * @return     string
	 */
	public function getRoommateTypeName()
	{
		return $this->roommate_type_name;
	}
	 ...
	 * @return     RoommateType The current object (for fluent API support)
	 */
	public function setRoommateTypeId($v)
	{
		...
		if ($this->roommate_type_id !== $v) {
			...
			$this->modifiedColumns[] = RoommateTypePeer::ROOMMATE_TYPE_ID;
		}
	...
	/**
	 * Set the value of [roommate_type_name] column.
	 * 
	 * @param      string $v new value
	 * @return     RoommateType The current object (for fluent API support)
	 */
	public function setRoommateTypeName($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->roommate_type_name !== $v) {
			$this->roommate_type_name = $v;
			$this->modifiedColumns[] = RoommateTypePeer::ROOMMATE_TYPE_NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->roommate_type_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->roommate_type_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = RoommateTypePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating RoommateType object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = RoommateTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = RoommateTypeQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				RoommateTypePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(RoommateTypePeer::ROOMMATE_TYPE_ID)) {
			$modifiedColumns[':p' . $index++]  = '`ROOMMATE_TYPE_ID`';
		}
		if ($this->isColumnModified(RoommateTypePeer::ROOMMATE_TYPE_NAME)) {
			$modifiedColumns[':p' . $index++]  = '`ROOMMATE_TYPE_NAME`';
		}

		$sql = sprintf(
			'INSERT INTO `roommate_type` (%s) VALUES (%s)',
			...
			foreach ($modifiedColumns as $identifier => $columnName) {
				switch ($columnName) {
					case '`ROOMMATE_TYPE_ID`':
						...
						break;
					case '`ROOMMATE_TYPE_NAME`':
						$stmt->bindValue($identifier, $this->roommate_type_name, PDO::PARAM_STR);
						break;
				}
			}
			$stmt->execute();
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RoommateTypePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RoommateTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				return $this->getRoommateTypeName();
				break;
			default:
				return null;
				break;
	...
	{
		if (isset($alreadyDumpedObjects['RoommateType'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['RoommateType'][$this->getPrimaryKey()] = true;
		$keys = RoommateTypePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getRoommateTypeId(),
			$keys[1] => $this->getRoommateTypeName(),
		);
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				$this->setRoommateTypeName($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setRoommateTypeId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setRoommateTypeName($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RoommateTypePeer::ROOMMATE_TYPE_ID)) $criteria->add(RoommateTypePeer::ROOMMATE_TYPE_ID, $this->roommate_type_id);
		if ($this->isColumnModified(RoommateTypePeer::ROOMMATE_TYPE_NAME)) $criteria->add(RoommateTypePeer::ROOMMATE_TYPE_NAME, $this->roommate_type_name);
	...
	{
		$criteria = new Criteria(RoommateTypePeer::DATABASE_NAME);
		$criteria->add(RoommateTypePeer::ROOMMATE_TYPE_ID, $this->roommate_type_id);
	...
	/**
	 * Generic method to set the primary key (roommate_type_id column).
	 *
	...
	{
		return null === $this->getRoommateTypeId();
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of RoommateType (or compatible) type.
	...
	{
		$copyObj->setRoommateTypeName($this->getRoommateTypeName());
		...
		if ($makeNew) {
			$copyObj->setNew(true);
			$copyObj->setRoommateTypeId(NULL); // this is a auto-increment column, so set to default value
		}
	}
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     RoommateType Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     RoommateTypePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new RoommateTypePeer();
		}
		return self::$peer;
	}
	 ...
	 * If this RoommateType is new, it will return
	 ...
	 * Otherwise if this RoommateType is new, it will return
	 * an empty collection; or if this RoommateType has previously
	 * been saved, it will retrieve related Commuters from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in RoommateType.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array Commuter[] List of Commuter objects
	 */
	public function getCommutersJoinDwellingChoice($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = CommuterQuery::create(null, $criteria);
		$query->joinWith('DwellingChoice', $join_behavior);
	...
	{
		return (string) $this->exportTo(RoommateTypePeer::DEFAULT_STRING_FORMAT);
	}
