...
use ClubsORM\map\UsersTableMap;
...
abstract class BaseUsersPeer {
	...
	const OM_CLASS = 'ClubsORM\\Users';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'clubs.Users';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserId', 'Level', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'level', ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID, self::LEVEL, ),
		BasePeer::TYPE_RAW_COLNAME => array ('USER_ID', 'LEVEL', ),
		BasePeer::TYPE_FIELDNAME => array ('user_id', 'level', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'Level' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'level' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID => 0, self::LEVEL => 1, ),
		BasePeer::TYPE_RAW_COLNAME => array ('USER_ID' => 0, 'LEVEL' => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'level' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(UsersPeer::LEVEL);
		} else {
