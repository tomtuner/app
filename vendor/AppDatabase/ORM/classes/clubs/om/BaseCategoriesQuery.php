...
use \Propel;
use \PropelPDO;
use ClubsORM\Categories;
use ClubsORM\CategoriesPeer;
use ClubsORM\CategoriesQuery;
...
abstract class BaseCategoriesQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'clubs', $modelName = 'ClubsORM\\Categories', $modelAlias = null)
	{
