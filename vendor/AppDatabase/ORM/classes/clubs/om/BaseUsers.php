...
abstract class BaseUsers extends BaseObject  implements Persistent
{
	...
	public function setLevel($v)
	{
		...
		if ($this->level !== $v) {
			$this->level = $v;
			$this->modifiedColumns[] = UsersPeer::LEVEL;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = UsersPeer::NUM_HYDRATE_COLUMNS.
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(UsersPeer::LEVEL)) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UsersPeer::LEVEL)) $criteria->add(UsersPeer::LEVEL, $this->level);
