...
abstract class BaseQuarterlyEvents extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
	const PEER = 'ClubsORM\\QuarterlyEventsPeer';
	...
	/**
	 * The value for the quarterly_event_type_id field.
	 * Note: this column has a database default value of: 0
	 * @var        int
	 */
	protected $quarterly_event_type_id;
	...
	public function applyDefaultValues()
	{
		...
		$this->quarterly_event_type_id = 0;
		$this->held_on = '';
		$this->num_members = 0;
		$this->num_outside = 0;
	}
	...
	/**
	 * Get the [quarterly_event_type_id] column value.
	 * 
	 * @return     int
	 */
	public function getQuarterlyEventTypeId()
	{
		return $this->quarterly_event_type_id;
	}
	...
	public function setQuarterlyReportId($v)
	{
		...
		if ($this->quarterly_report_id !== $v) {
			...
			$this->modifiedColumns[] = QuarterlyEventsPeer::QUARTERLY_REPORT_ID;
		}
	...
	/**
	 * Set the value of [quarterly_event_type_id] column.
	 * 
	 * @param      int $v new value
	 * @return     QuarterlyEvents The current object (for fluent API support)
	 */
	public function setQuarterlyEventTypeId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->quarterly_event_type_id !== $v) {
			$this->quarterly_event_type_id = $v;
			$this->modifiedColumns[] = QuarterlyEventsPeer::QUARTERLY_EVENT_TYPE_ID;
		}

		return $this;
	} // setQuarterlyEventTypeId()
	...
	public function hasOnlyDefaultValues()
	{
			...
			if ($this->quarterly_event_type_id !== 0) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->quarterly_event_type_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(QuarterlyEventsPeer::QUARTERLY_REPORT_ID)) {
			$modifiedColumns[':p' . $index++]  = '`QUARTERLY_REPORT_ID`';
		}
		if ($this->isColumnModified(QuarterlyEventsPeer::QUARTERLY_EVENT_TYPE_ID)) {
			$modifiedColumns[':p' . $index++]  = '`QUARTERLY_EVENT_TYPE_ID`';
		}
			...
			foreach ($modifiedColumns as $identifier => $columnName) {
				switch ($columnName) {
					...
					case '`QUARTERLY_REPORT_ID`':
						...
						break;
					case '`QUARTERLY_EVENT_TYPE_ID`':
						$stmt->bindValue($identifier, $this->quarterly_event_type_id, PDO::PARAM_INT);
						break;
					case '`HELD_ON`':
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				return $this->getQuarterlyEventTypeId();
				break;
			case 3:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
	{
		...
		$result = array(
			...
			$keys[2] => $this->getQuarterlyEventTypeId(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				$this->setQuarterlyEventTypeId($value);
				break;
			case 3:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setQuarterlyEventTypeId($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(QuarterlyEventsPeer::QUARTERLY_REPORT_ID)) $criteria->add(QuarterlyEventsPeer::QUARTERLY_REPORT_ID, $this->quarterly_report_id);
		if ($this->isColumnModified(QuarterlyEventsPeer::QUARTERLY_EVENT_TYPE_ID)) $criteria->add(QuarterlyEventsPeer::QUARTERLY_EVENT_TYPE_ID, $this->quarterly_event_type_id);
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setQuarterlyEventTypeId($this->getQuarterlyEventTypeId());
	...
	public function clear()
	{
		...
		$this->quarterly_event_type_id = null;
		$this->held_on = null;
