...
use ArtRequestORM\FlyerFormatQuery;
...
abstract class BaseFlyerFormatQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'art_request', $modelName = 'ArtRequestORM\\FlyerFormat', $modelAlias = null)
    {
     ...
     * @param     FlyerFormatQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   FlyerFormat|FlyerFormat[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|FlyerFormat[]|mixed the list of results, formatted by the current formatter
     */
