...
abstract class BaseArtRequestorQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'art_request', $modelName = 'ArtRequestORM\\ArtRequestor', $modelAlias = null)
    {
     ...
     * @param     ArtRequestorQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   ArtRequestor|ArtRequestor[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|ArtRequestor[]|mixed the list of results, formatted by the current formatter
     */
