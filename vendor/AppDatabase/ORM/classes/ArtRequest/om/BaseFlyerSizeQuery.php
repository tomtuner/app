...
abstract class BaseFlyerSizeQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'art_request', $modelName = 'ArtRequestORM\\FlyerSize', $modelAlias = null)
    {
     ...
     * @param     FlyerSizeQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   FlyerSize|FlyerSize[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|FlyerSize[]|mixed the list of results, formatted by the current formatter
     */
