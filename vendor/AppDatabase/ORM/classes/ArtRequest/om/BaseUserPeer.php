...
use ArtRequestORM\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'ArtRequestORM\\User';
    ...
    /** the column name for the USER_DCE_NAME field */
    const USER_DCE_NAME = 'user.USER_DCE_NAME';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('UserId', 'UserDceName', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'userDceName', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::USER_ID, UserPeer::USER_DCE_NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER_ID', 'USER_DCE_NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('user_id', 'user_dce_name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'UserDceName' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'userDceName' => 1, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::USER_ID => 0, UserPeer::USER_DCE_NAME => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER_ID' => 0, 'USER_DCE_NAME' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'user_dce_name' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserPeer::USER_DCE_NAME);
        } else {
            $criteria->addSelectColumn($alias . '.USER_ID');
            $criteria->addSelectColumn($alias . '.USER_DCE_NAME');
        }
    }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(ArtRequestCommentPeer::USER_ID, $obj->getUserId());
