...
abstract class BaseArtRequestCommentQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'art_request', $modelName = 'ArtRequestORM\\ArtRequestComment', $modelAlias = null)
    {
     ...
     * @param     ArtRequestCommentQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   ArtRequestComment|ArtRequestComment[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|ArtRequestComment[]|mixed the list of results, formatted by the current formatter
     */
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \ArtRequestORM\UserQuery A secondary query class using the current class as primary query
     */
    public function useUserQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinUser($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'User', '\ArtRequestORM\UserQuery');
    }
