...
/**
 * Base class that represents a row from the 'art_request_art_request_type' table.
 *
 *
 *
 * @package    propel.generator.ArtRequest.om
 */
abstract class BaseArtRequestArtRequestType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ArtRequestORM\\ArtRequestArtRequestTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ArtRequestArtRequestTypePeer
     */
     ...
     * @return ArtRequestArtRequestType The current object (for fluent API support)
     */
    public function setArtRequestTypeId($v)
    {
        ...
        if ($this->art_request_type_id !== $v) {
            ...
            $this->modifiedColumns[] = ArtRequestArtRequestTypePeer::ART_REQUEST_TYPE_ID;
        }
    ...
    public function setArtRequestId($v)
    {
        ...
        if ($this->art_request_id !== $v) {
            ...
            $this->modifiedColumns[] = ArtRequestArtRequestTypePeer::ART_REQUEST_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ArtRequestArtRequestTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ArtRequestArtRequestType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ArtRequestArtRequestTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ArtRequestArtRequestTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ArtRequestArtRequestTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ArtRequestArtRequestTypePeer::ART_REQUEST_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`ART_REQUEST_TYPE_ID`';
        }
        if ($this->isColumnModified(ArtRequestArtRequestTypePeer::ART_REQUEST_ID)) {
            $modifiedColumns[':p' . $index++]  = '`ART_REQUEST_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `art_request_art_request_type` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ArtRequestArtRequestTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ArtRequestArtRequestTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ArtRequestArtRequestType'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ArtRequestArtRequestType'][serialize($this->getPrimaryKey())] = true;
        $keys = ArtRequestArtRequestTypePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArtRequestArtRequestTypePeer::ART_REQUEST_TYPE_ID)) $criteria->add(ArtRequestArtRequestTypePeer::ART_REQUEST_TYPE_ID, $this->art_request_type_id);
        if ($this->isColumnModified(ArtRequestArtRequestTypePeer::ART_REQUEST_ID)) $criteria->add(ArtRequestArtRequestTypePeer::ART_REQUEST_ID, $this->art_request_id);
    ...
    {
        $criteria = new Criteria(ArtRequestArtRequestTypePeer::DATABASE_NAME);
        $criteria->add(ArtRequestArtRequestTypePeer::ART_REQUEST_TYPE_ID, $this->art_request_type_id);
        $criteria->add(ArtRequestArtRequestTypePeer::ART_REQUEST_ID, $this->art_request_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ArtRequestArtRequestType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ArtRequestArtRequestType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ArtRequestArtRequestTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ArtRequestArtRequestTypePeer();
        }
    ...
    public function setArtRequest(ArtRequest $v = null)
    {
        ...
        if ($v !== null) {
            $v->addArtRequestArtRequestType($this);
        }
    ...
    public function getArtRequest(PropelPDO $con = null)
    {
        if ($this->aArtRequest === null && ($this->art_request_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aArtRequest->addArtRequestArtRequestTypes($this);
             */
        }
    ...
    public function getArtRequestType(PropelPDO $con = null)
    {
        if ($this->aArtRequestType === null && ($this->art_request_type_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aArtRequestType->addArtRequestArtRequestTypes($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ArtRequestArtRequestTypePeer::DEFAULT_STRING_FORMAT);
    }
