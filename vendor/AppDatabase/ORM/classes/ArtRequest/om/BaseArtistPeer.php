...
use ArtRequestORM\map\ArtistTableMap;
...
abstract class BaseArtistPeer
{
    ...
    const OM_CLASS = 'ArtRequestORM\\Artist';
    ...
    /** the column name for the ARTIST_DCE_NAME field */
    const ARTIST_DCE_NAME = 'artist.ARTIST_DCE_NAME';

    /** the column name for the ARTIST_FIRST_NAME field */
    const ARTIST_FIRST_NAME = 'artist.ARTIST_FIRST_NAME';

    /** the column name for the ARTIST_LAST_NAME field */
    const ARTIST_LAST_NAME = 'artist.ARTIST_LAST_NAME';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('ArtistId', 'ArtistDceName', 'ArtistFirstName', 'ArtistLastName', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('artistId', 'artistDceName', 'artistFirstName', 'artistLastName', ),
        BasePeer::TYPE_COLNAME => array (ArtistPeer::ARTIST_ID, ArtistPeer::ARTIST_DCE_NAME, ArtistPeer::ARTIST_FIRST_NAME, ArtistPeer::ARTIST_LAST_NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ARTIST_ID', 'ARTIST_DCE_NAME', 'ARTIST_FIRST_NAME', 'ARTIST_LAST_NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('artist_id', 'artist_dce_name', 'artist_first_name', 'artist_last_name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('ArtistId' => 0, 'ArtistDceName' => 1, 'ArtistFirstName' => 2, 'ArtistLastName' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('artistId' => 0, 'artistDceName' => 1, 'artistFirstName' => 2, 'artistLastName' => 3, ),
        BasePeer::TYPE_COLNAME => array (ArtistPeer::ARTIST_ID => 0, ArtistPeer::ARTIST_DCE_NAME => 1, ArtistPeer::ARTIST_FIRST_NAME => 2, ArtistPeer::ARTIST_LAST_NAME => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ARTIST_ID' => 0, 'ARTIST_DCE_NAME' => 1, 'ARTIST_FIRST_NAME' => 2, 'ARTIST_LAST_NAME' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('artist_id' => 0, 'artist_dce_name' => 1, 'artist_first_name' => 2, 'artist_last_name' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ArtistPeer::ARTIST_DCE_NAME);
            $criteria->addSelectColumn(ArtistPeer::ARTIST_FIRST_NAME);
            $criteria->addSelectColumn(ArtistPeer::ARTIST_LAST_NAME);
        } else {
            $criteria->addSelectColumn($alias . '.ARTIST_ID');
            $criteria->addSelectColumn($alias . '.ARTIST_DCE_NAME');
            $criteria->addSelectColumn($alias . '.ARTIST_FIRST_NAME');
            $criteria->addSelectColumn($alias . '.ARTIST_LAST_NAME');
        }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ArtistPeer::ARTIST_ID) && $criteria->keyContainsValue(ArtistPeer::ARTIST_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(ArtistPeer::ARTIST_ID);
            if ($value) {
                $selectCriteria->add(ArtistPeer::ARTIST_ID, $value, $comparison);
            } else {
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += ArtistPeer::doOnDeleteCascade(new Criteria(ArtistPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += ArtistPeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = ArtistPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {
            ...
            $criteria->add(ArtRequestAssignmentPeer::ARTIST_ID, $obj->getArtistId());
