...
abstract class BaseUser extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'ArtRequestORM\\UserPeer';
    ...
    /**
     * The value for the user_dce_name field.
     * @var        string
     */
    protected $user_dce_name;

    /**
     * @var        PropelObjectCollection|ArtRequestComment[] Collection to store aggregation of ArtRequestComment objects.
     */
    protected $collArtRequestComments;
    protected $collArtRequestCommentsPartial;
    ...
    /**
     * Get the [user_dce_name] column value.
     *
     * @return string
     */
    public function getUserDceName()
    {
        return $this->user_dce_name;
    }
    ...
    /**
     * Set the value of [user_dce_name] column.
     *
     * @param string $v new value
     * @return User The current object (for fluent API support)
     */
    public function setUserDceName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->user_dce_name !== $v) {
            $this->user_dce_name = $v;
            $this->modifiedColumns[] = UserPeer::USER_DCE_NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->user_dce_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserPeer::USER_DCE_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`USER_DCE_NAME`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`USER_ID`':
                        ...
                        break;
                    case '`USER_DCE_NAME`':
                        $stmt->bindValue($identifier, $this->user_dce_name, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setUserDceName($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserPeer::USER_DCE_NAME)) $criteria->add(UserPeer::USER_DCE_NAME, $this->user_dce_name);
    ...
    {
        $copyObj->setUserDceName($this->getUserDceName());
    ...
    public function clearArtRequestComments()
    {
        ...
        $this->collArtRequestCommentsPartial = null;
    }

    /**
     * reset is the collArtRequestComments collection loaded partially
     *
     * @return void
     */
    public function resetPartialArtRequestComments($v = true)
    {
        $this->collArtRequestCommentsPartial = $v;
    }
     ...
     * @return PropelObjectCollection|ArtRequestComment[] List of ArtRequestComment objects
     * @throws PropelException
     */
    public function getArtRequestComments($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collArtRequestCommentsPartial && !$this->isNew();
        if (null === $this->collArtRequestComments || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collArtRequestComments) {
                ...
                $collArtRequestComments = ArtRequestCommentQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collArtRequestCommentsPartial && count($collArtRequestComments)) {
                      $this->initArtRequestComments(false);

                      foreach($collArtRequestComments as $obj) {
                        if (false == $this->collArtRequestComments->contains($obj)) {
                          $this->collArtRequestComments->append($obj);
                        }
                      }

                      $this->collArtRequestCommentsPartial = true;
                    }

                    return $collArtRequestComments;
                }

                if($partial && $this->collArtRequestComments) {
                    foreach($this->collArtRequestComments as $obj) {
                        if($obj->isNew()) {
                            $collArtRequestComments[] = $obj;
                        }
                    }
                }

                $this->collArtRequestComments = $collArtRequestComments;
                $this->collArtRequestCommentsPartial = false;
            }
        }
    ...
    public function setArtRequestComments(PropelCollection $artRequestComments, PropelPDO $con = null)
    {
        ...
        foreach ($this->artRequestCommentsScheduledForDeletion as $artRequestCommentRemoved) {
            $artRequestCommentRemoved->setUser(null);
        }
    ...
    public function countArtRequestComments(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collArtRequestComments || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collArtRequestComments) {
                ...
                if($partial && !$criteria) {
                    return count($this->getArtRequestComments());
                }
    ...
    protected function doAddArtRequestComment($artRequestComment)
    {
        ...
        $artRequestComment->setUser($this);
    }

    /**
     * @param	ArtRequestComment $artRequestComment The artRequestComment object to remove.
     */
    public function removeArtRequestComment($artRequestComment)
    {
        if ($this->getArtRequestComments()->contains($artRequestComment)) {
            $this->collArtRequestComments->remove($this->collArtRequestComments->search($artRequestComment));
            if (null === $this->artRequestCommentsScheduledForDeletion) {
                $this->artRequestCommentsScheduledForDeletion = clone $this->collArtRequestComments;
                $this->artRequestCommentsScheduledForDeletion->clear();
            }
            $this->artRequestCommentsScheduledForDeletion[]= $artRequestComment;
            $artRequestComment->setUser(null);
        }
    }
