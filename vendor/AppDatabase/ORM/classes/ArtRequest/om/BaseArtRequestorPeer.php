...
use ArtRequestORM\map\ArtRequestorTableMap;
...
abstract class BaseArtRequestorPeer
{
    ...
    const OM_CLASS = 'ArtRequestORM\\ArtRequestor';
     ...
     * e.g. ArtRequestorPeer::$fieldNames[ArtRequestorPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ArtRequestorPeer::ART_REQUESTOR_ID, ArtRequestorPeer::DCE_NAME, ArtRequestorPeer::FIRST_NAME, ArtRequestorPeer::LAST_NAME, ArtRequestorPeer::EMAIL_ADDRESS, ArtRequestorPeer::PHONE_NUMBER, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. ArtRequestorPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ArtRequestorPeer::ART_REQUESTOR_ID => 0, ArtRequestorPeer::DCE_NAME => 1, ArtRequestorPeer::FIRST_NAME => 2, ArtRequestorPeer::LAST_NAME => 3, ArtRequestorPeer::EMAIL_ADDRESS => 4, ArtRequestorPeer::PHONE_NUMBER => 5, ),
    ...
    {
        $toNames = ArtRequestorPeer::getFieldNames($toType);
        $key = isset(ArtRequestorPeer::$fieldKeys[$fromType][$name]) ? ArtRequestorPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(ArtRequestorPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, ArtRequestorPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return ArtRequestorPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ArtRequestorPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ArtRequestorPeer::DATABASE_NAME);
     ...
     *
     * @param      ArtRequestor $obj A ArtRequestor object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            ArtRequestorPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(ArtRequestorPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(ArtRequestorPeer::$instances[$key])) {
                return ArtRequestorPeer::$instances[$key];
            }
        }
    ...
    {
        ArtRequestorPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(ArtRequestorPeer::DATABASE_NAME)->getTable(ArtRequestorPeer::TABLE_NAME);
    }
    ...
    {
        return ArtRequestorPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(ArtRequestorPeer::DATABASE_NAME);
