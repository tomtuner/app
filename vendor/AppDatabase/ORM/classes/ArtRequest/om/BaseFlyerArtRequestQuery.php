...
abstract class BaseFlyerArtRequestQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'art_request', $modelName = 'ArtRequestORM\\FlyerArtRequest', $modelAlias = null)
    {
     ...
     * @param     FlyerArtRequestQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   FlyerArtRequest|FlyerArtRequest[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|FlyerArtRequest[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param   FlyerSize|PropelObjectCollection $flyerSize The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   FlyerArtRequestQuery The current query, for fluid interface
    ...
    public function filterByFlyerSize($flyerSize, $comparison = null)
    {
        ...
        } elseif ($flyerSize instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \ArtRequestORM\FlyerSizeQuery A secondary query class using the current class as primary query
     */
    public function useFlyerSizeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinFlyerSize($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'FlyerSize', '\ArtRequestORM\FlyerSizeQuery');
    }

    /**
     * Filter the query by a related FlyerFormat object
     *
     * @param   FlyerFormat|PropelObjectCollection $flyerFormat The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   FlyerArtRequestQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByFlyerFormat($flyerFormat, $comparison = null)
    {
        ...
        } elseif ($flyerFormat instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \ArtRequestORM\FlyerFormatQuery A secondary query class using the current class as primary query
     */
    public function useFlyerFormatQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'FlyerFormat', '\ArtRequestORM\FlyerFormatQuery');
    }
