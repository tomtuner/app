...
/**
 * Base class that represents a row from the 'art_request_assignment' table.
 *
 *
 *
 * @package    propel.generator.ArtRequest.om
 */
abstract class BaseArtRequestAssignment extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ArtRequestORM\\ArtRequestAssignmentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ArtRequestAssignmentPeer
     */
     ...
     * @return ArtRequestAssignment The current object (for fluent API support)
     */
    public function setArtRequestId($v)
    {
        ...
        if ($this->art_request_id !== $v) {
            ...
            $this->modifiedColumns[] = ArtRequestAssignmentPeer::ART_REQUEST_ID;
        }
    ...
    public function setArtistId($v)
    {
        ...
        if ($this->artist_id !== $v) {
            $this->artist_id = $v;
            $this->modifiedColumns[] = ArtRequestAssignmentPeer::ARTIST_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ArtRequestAssignmentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ArtRequestAssignment object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ArtRequestAssignmentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ArtRequestAssignmentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ArtRequestAssignmentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ArtRequestAssignmentPeer::ART_REQUEST_ID)) {
            $modifiedColumns[':p' . $index++]  = '`ART_REQUEST_ID`';
        }
        if ($this->isColumnModified(ArtRequestAssignmentPeer::ARTIST_ID)) {
            $modifiedColumns[':p' . $index++]  = '`ARTIST_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `art_request_assignment` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ArtRequestAssignmentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ArtRequestAssignmentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ArtRequestAssignment'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ArtRequestAssignment'][serialize($this->getPrimaryKey())] = true;
        $keys = ArtRequestAssignmentPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArtRequestAssignmentPeer::ART_REQUEST_ID)) $criteria->add(ArtRequestAssignmentPeer::ART_REQUEST_ID, $this->art_request_id);
        if ($this->isColumnModified(ArtRequestAssignmentPeer::ARTIST_ID)) $criteria->add(ArtRequestAssignmentPeer::ARTIST_ID, $this->artist_id);
    ...
    {
        $criteria = new Criteria(ArtRequestAssignmentPeer::DATABASE_NAME);
        $criteria->add(ArtRequestAssignmentPeer::ART_REQUEST_ID, $this->art_request_id);
        $criteria->add(ArtRequestAssignmentPeer::ARTIST_ID, $this->artist_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getArtRequestId()) && (null === $this->getArtistId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ArtRequestAssignment (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ArtRequestAssignment Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ArtRequestAssignmentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ArtRequestAssignmentPeer();
        }
    ...
    public function setArtRequest(ArtRequest $v = null)
    {
        ...
        if ($v !== null) {
            $v->addArtRequestAssignment($this);
        }
    ...
    public function getArtRequest(PropelPDO $con = null)
    {
        if ($this->aArtRequest === null && ($this->art_request_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aArtRequest->addArtRequestAssignments($this);
             */
        }
    ...
    public function getArtist(PropelPDO $con = null)
    {
        if ($this->aArtist === null && ($this->artist_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aArtist->addArtRequestAssignments($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ArtRequestAssignmentPeer::DEFAULT_STRING_FORMAT);
    }
