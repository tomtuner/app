 ...
 *
 * @method BannerLocationQuery leftJoinBannerArtRequest($relationAlias = null) Adds a LEFT JOIN clause to the query using the BannerArtRequest relation
 * @method BannerLocationQuery rightJoinBannerArtRequest($relationAlias = null) Adds a RIGHT JOIN clause to the query using the BannerArtRequest relation
 * @method BannerLocationQuery innerJoinBannerArtRequest($relationAlias = null) Adds a INNER JOIN clause to the query using the BannerArtRequest relation
 *
...
abstract class BaseBannerLocationQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'art_request', $modelName = 'ArtRequestORM\\BannerLocation', $modelAlias = null)
    {
     ...
     * @param     BannerLocationQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   BannerLocation|BannerLocation[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|BannerLocation[]|mixed the list of results, formatted by the current formatter
     */
    ...
    public function filterByBannerArtRequest($bannerArtRequest, $comparison = null)
    {
        if ($bannerArtRequest instanceof BannerArtRequest) {
            return $this
                ->addUsingAlias(BannerLocationPeer::BANNER_LOCATION_ID, $bannerArtRequest->getBannerLocationId(), $comparison);
