...
/**
 * Base class that represents a row from the 'art_requestor_art_request_type' table.
 *
 *
 *
 * @package    propel.generator.ArtRequest.om
 */
abstract class BaseArtRequestorArtRequestType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ArtRequestORM\\ArtRequestorArtRequestTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ArtRequestorArtRequestTypePeer
     */
     ...
     * @return ArtRequestorArtRequestType The current object (for fluent API support)
     */
    public function setArtRequestTypeId($v)
    {
        ...
        if ($this->art_request_type_id !== $v) {
            ...
            $this->modifiedColumns[] = ArtRequestorArtRequestTypePeer::ART_REQUEST_TYPE_ID;
        }
    ...
    public function setArtRequestId($v)
    {
        ...
        if ($this->art_request_id !== $v) {
            ...
            $this->modifiedColumns[] = ArtRequestorArtRequestTypePeer::ART_REQUEST_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ArtRequestorArtRequestTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ArtRequestorArtRequestType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ArtRequestorArtRequestTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ArtRequestorArtRequestTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ArtRequestorArtRequestTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ArtRequestorArtRequestTypePeer::ART_REQUEST_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`ART_REQUEST_TYPE_ID`';
        }
        if ($this->isColumnModified(ArtRequestorArtRequestTypePeer::ART_REQUEST_ID)) {
            $modifiedColumns[':p' . $index++]  = '`ART_REQUEST_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `art_requestor_art_request_type` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ArtRequestorArtRequestTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ArtRequestorArtRequestTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ArtRequestorArtRequestType'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ArtRequestorArtRequestType'][serialize($this->getPrimaryKey())] = true;
        $keys = ArtRequestorArtRequestTypePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArtRequestorArtRequestTypePeer::ART_REQUEST_TYPE_ID)) $criteria->add(ArtRequestorArtRequestTypePeer::ART_REQUEST_TYPE_ID, $this->art_request_type_id);
        if ($this->isColumnModified(ArtRequestorArtRequestTypePeer::ART_REQUEST_ID)) $criteria->add(ArtRequestorArtRequestTypePeer::ART_REQUEST_ID, $this->art_request_id);
    ...
    {
        $criteria = new Criteria(ArtRequestorArtRequestTypePeer::DATABASE_NAME);
        $criteria->add(ArtRequestorArtRequestTypePeer::ART_REQUEST_TYPE_ID, $this->art_request_type_id);
        $criteria->add(ArtRequestorArtRequestTypePeer::ART_REQUEST_ID, $this->art_request_id);
    ...
    {
        $pks = array();
        $pks[0] = $this->getArtRequestTypeId();
        $pks[1] = $this->getArtRequestId();
    ...
    {
        $this->setArtRequestTypeId($keys[0]);
        $this->setArtRequestId($keys[1]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getArtRequestTypeId()) && (null === $this->getArtRequestId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ArtRequestorArtRequestType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ArtRequestorArtRequestType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ArtRequestorArtRequestTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ArtRequestorArtRequestTypePeer();
        }
    ...
    public function setArtRequest(ArtRequest $v = null)
    {
        ...
        if ($v !== null) {
            $v->addArtRequestorArtRequestType($this);
        }
    ...
    public function getArtRequest(PropelPDO $con = null)
    {
        if ($this->aArtRequest === null && ($this->art_request_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aArtRequest->addArtRequestorArtRequestTypes($this);
             */
        }
    ...
    public function getArtRequestType(PropelPDO $con = null)
    {
        if ($this->aArtRequestType === null && ($this->art_request_type_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aArtRequestType->addArtRequestorArtRequestTypes($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ArtRequestorArtRequestTypePeer::DEFAULT_STRING_FORMAT);
    }
