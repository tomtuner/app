...
class FlyerArtRequestTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ArtRequest.map.FlyerArtRequestTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('ArtRequestORM\\FlyerArtRequest');
    ...
    {
        $this->addRelation('FlyerSize', 'ArtRequestORM\\FlyerSize', RelationMap::MANY_TO_ONE, array('flyer_size_id' => 'flyer_size_id', ), 'CASCADE', 'CASCADE');
        $this->addRelation('FlyerFormat', 'ArtRequestORM\\FlyerFormat', RelationMap::MANY_TO_ONE, array('flyer_format_id' => 'flyer_format_id', ), 'CASCADE', 'CASCADE');
