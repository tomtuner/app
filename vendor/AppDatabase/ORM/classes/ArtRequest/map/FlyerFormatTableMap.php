...
class FlyerFormatTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ArtRequest.map.FlyerFormatTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('ArtRequestORM\\FlyerFormat');
    ...
    {
        $this->addRelation('FlyerArtRequest', 'ArtRequestORM\\FlyerArtRequest', RelationMap::ONE_TO_MANY, array('flyer_format_id' => 'flyer_format_id', ), 'CASCADE', 'CASCADE', 'FlyerArtRequests');
    } // buildRelations()
