...
/**
 * This class defines the structure of the 'art_request_art_request_type' table.
 *
 *
 *
 ...
 */
class ArtRequestArtRequestTypeTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'ArtRequest.map.ArtRequestArtRequestTypeTableMap';
    ...
    {
        // attributes
        $this->setName('art_request_art_request_type');
        $this->setPhpName('ArtRequestArtRequestType');
        $this->setClassname('ArtRequestORM\\ArtRequestArtRequestType');
...
} // ArtRequestArtRequestTypeTableMap
