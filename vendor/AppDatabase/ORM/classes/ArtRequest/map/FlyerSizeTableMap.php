...
class FlyerSizeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ArtRequest.map.FlyerSizeTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('ArtRequestORM\\FlyerSize');
    ...
    {
        $this->addRelation('FlyerArtRequest', 'ArtRequestORM\\FlyerArtRequest', RelationMap::ONE_TO_MANY, array('flyer_size_id' => 'flyer_size_id', ), 'CASCADE', 'CASCADE', 'FlyerArtRequests');
    } // buildRelations()
