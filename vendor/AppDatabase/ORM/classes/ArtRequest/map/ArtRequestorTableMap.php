...
class ArtRequestorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ArtRequest.map.ArtRequestorTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('ArtRequestORM\\ArtRequestor');
        ...
        $this->addColumn('PHONE_NUMBER', 'PhoneNumber', 'VARCHAR', true, 14, null);
        // validators
    } // initialize()
    ...
    {
        $this->addRelation('ArtRequest', 'ArtRequestORM\\ArtRequest', RelationMap::ONE_TO_MANY, array('art_requestor_id' => 'art_requestor_id', ), 'CASCADE', 'CASCADE', 'ArtRequests');
    } // buildRelations()
