...
class ArtRequestTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ArtRequest.map.ArtRequestTypeTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('ArtRequestORM\\ArtRequestType');
    ...
    {
        $this->addRelation('ArtRequestArtRequestType', 'ArtRequestORM\\ArtRequestArtRequestType', RelationMap::ONE_TO_MANY, array('art_request_type_id' => 'art_request_type_id', ), 'CASCADE', 'CASCADE', 'ArtRequestArtRequestTypes');
    } // buildRelations()
