...
/**
 * This class defines the structure of the 'banner_art_request' table.
 *
 *
 *
 ...
 */
class BannerArtRequestTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'ArtRequest.map.BannerArtRequestTableMap';
    ...
    {
        // attributes
        $this->setName('banner_art_request');
        $this->setPhpName('BannerArtRequest');
        $this->setClassname('ArtRequestORM\\BannerArtRequest');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('BannerLocation', 'ArtRequestORM\\BannerLocation', RelationMap::MANY_TO_ONE, array('banner_location_id' => 'banner_location_id', ), 'CASCADE', 'CASCADE');
    } // buildRelations()

} // BannerArtRequestTableMap
